...
export const navData = [
	{ name: "home", path: "/", icon: <HiHome /> },
	{
		...
		path: "/tempusunlimited",
		icon: <Bs1Circle />,
	},
	{ name: "LuxeSeasons", path: "/luxeseasons", icon: <Bs2Circle /> },
	{
		name: "contact",
		path: "/contact",
		icon: <HiEnvelope />,
...
const Nav = () => {
	...
	return (
		<nav className="flex fex-col items-center xl:justify-center gap-y-4 fixed h-max bottom-0 mt-auto xl:right-[2%] z-50 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen ">
			<div className="flex w-full xl:flex-col items-center justify-between xl:justify-center gap-y-10 px-4 md:px-40 xl:px-0 h-[80px] bg-white/10 xl:h-max py-8  text-3xl xl:text-xl xl:rounded-full">
